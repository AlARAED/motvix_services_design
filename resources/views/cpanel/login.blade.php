...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{url('admin/')}}/assets/pages/img/logo (1).png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form"     action="{{ route('adminlogin') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix @error('name') is-invalid @enderror" type="text" autocomplete="off" placeholder="Username" name="name" required autocomplete="name" />
                     @error('name')
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix " type="password" autocomplete="off" placeholder="Password" name="password" required autocomplete="current-password"/>
                      @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
 ...
 -->                </div>
                <!-- <div class="login-options">
                    ...
                    <ul class="social-icons">
                        <li>
                            <a class="social-icon-color facebook" data-original-title="facebook" href="javascript:;{{url('admin/')}}"></a>
                        </li>
                        <li>
 ...
 -->                    </p>
            ...
            <!-- <form class="register-form" action="index.html" method="post">
                ...
                <div class="form-group">
                    ...
                    <i{{url('admin/')}}nput class="form-control placeholder-no-fix" type="text" placeholder="Email" name="email" /> </div>
                <div class="form-group">
        ...
        <div class="copyright"> 2020 © motiv-x. Admin Dashboard panel. </div>
        <!--[if lt IE 9]>
