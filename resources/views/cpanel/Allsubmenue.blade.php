                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-primary" href="editesubmainpage/{{ $Page->id }}">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
                                                 -->
                                                {!!  Form::open(['url' => ['admin/removecheldPage',$Page->id] ,'method' => 'POST','files' => true]) !!}
